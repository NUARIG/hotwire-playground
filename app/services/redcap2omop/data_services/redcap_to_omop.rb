module Redcap2omop::DataServices
  class RedcapToOmop
    ...
    MAPPABLE_DOMAIN_CONDITION = 'Condition'
    MAPPABLE_DOMAIN_DEATH_TYPE = 'Death Type'
    MAPPABLE_DOMAIN_DEVICE = 'Device'
    MAPPABLE_DOMAIN_DRUG = 'Drug'
    MAPPABLE_DOMAIN_MEASUREMENT = 'Measurement'
    MAPPABLE_DOMAIN_METADATA = 'Metadata'
    MAPPABLE_DOMAIN_OBSERVATION = 'Observation'
    MAPPABLE_DOMAIN_PROCEDURE = 'Procedure'
    MAPPABLE_DOMAIN_VISIT = 'Visit'
    MAPPABLE_DOMAINS = [MAPPABLE_DOMAIN_CONDITION, MAPPABLE_DOMAIN_DEATH_TYPE, MAPPABLE_DOMAIN_DEVICE, MAPPABLE_DOMAIN_DRUG, MAPPABLE_DOMAIN_MEASUREMENT, MAPPABLE_DOMAIN_METADATA, MAPPABLE_DOMAIN_OBSERVATION, MAPPABLE_DOMAIN_PROCEDURE, MAPPABLE_DOMAIN_VISIT]
    ...
    def get_omop_domain(redcap_variable_map)
      if redcap_project.route_to_observation || [Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_OBSERVATION, Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_METADATA].include?(redcap_variable_map.concept.domain_id)
        klass = Redcap2omop::Observation
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_MEASUREMENT
        klass = Redcap2omop::Measurement
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_CONDITION
        klass = Redcap2omop::ConditionOccurrence
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DEVICE
        klass = Redcap2omop::DeiceExposure
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DRUG
        klass = Redcap2omop::DrugExposure
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_PROCEDURE
        klass = Redcap2omop::ProcedureOccurrence
      elsif redcap_variable_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_VISIT
        klass = Redcap2omop::VisitOccurrence
      elsif redcap_variable_map.concept.vocabulary_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DEATH_TYPE
    ...
    def get_omop_domain_from_redcap_variable_choice_map(redcap_variable_choice_map)
      if redcap_project.route_to_observation || [Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_OBSERVATION, Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_METADATA].include?(redcap_variable_map.concept.domain_id)
        klass = Redcap2omop::Observation
      elsif redcap_variable_choice_map.concept.domain_id ==  Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_MEASUREMENT
        klass = Redcap2omop::Measurement
      elsif redcap_variable_choice_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_CONDITION
        klass = Redcap2omop::ConditionOccurrence
      elsif redcap_variable_choice_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DEVICE
        klass = Redcap2omop::DeviceExposure
      elsif redcap_variable_choice_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DRUG
        klass = Redcap2omop::DrugExposure
      elsif redcap_variable_choice_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_PROCEDURE
        klass = Redcap2omop::ProcedureOccurrence
      elsif redcap_variable_choice_map.concept.domain_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_VISIT
        klass = Redcap2omop::VisitOccurrence
      elsif redcap_variable_map.concept.vocabulary_id == Redcap2omop::DataServices::RedcapToOmop::MAPPABLE_DOMAIN_DEATH_TYPE
        klass = Redcap2omop::Death
      end
